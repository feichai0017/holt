...
in the holt community a harassment-free experience for everyone,
...
the GitHub repository, issue tracker, pull request reviews, and any
project-affiliated communication channel — and also applies when an
individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior
may be reported to the project maintainers via the repository's issue
tracker (for public matters) or a private channel listed in the
repository's README (for confidential matters). All complaints will
