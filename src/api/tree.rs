...
struct BufferStatsSnapshot {
    ...
    cold_lookup_negatives: u64,
    cold_lookup_crossings: u64,
    cold_lookup_fallbacks: u64,
...
impl BufferStatsSnapshot {
    fn collect(store: &BufferManager) -> Self {
        Self {
            ...
            cold_lookup_hits: store.cold_lookup_hits(),
            cold_lookup_negatives: store.cold_lookup_negatives(),
            cold_lookup_crossings: store.cold_lookup_crossings(),
            cold_lookup_fallbacks: store.cold_lookup_fallbacks(),
...
impl Tree {
    ...
    pub fn stats(&self) -> Result<TreeStats> {
        ...
        Ok(TreeStats {
            ...
            bm_cold_lookup_hits: bm.cold_lookup_hits,
            bm_cold_lookup_negatives: bm.cold_lookup_negatives,
            bm_cold_lookup_crossings: bm.cold_lookup_crossings,
            bm_cold_lookup_fallbacks: bm.cold_lookup_fallbacks,
