...
impl DB {
    ...
    pub fn stats(&self) -> DBStats {
        ...
        DBStats {
            ...
            bm_cold_lookup_hits: self.store.cold_lookup_hits(),
            bm_cold_lookup_negatives: self.store.cold_lookup_negatives(),
            bm_cold_lookup_crossings: self.store.cold_lookup_crossings(),
            bm_cold_lookup_fallbacks: self.store.cold_lookup_fallbacks(),
